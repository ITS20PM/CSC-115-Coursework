...
public class A1Tester {
	...
	public static void testGreatestCommonDenominator() {
		...
		System.out.println("Testing greatestCommonDenominator(10, 42)");
		result = A1Exercises.greatestCommonDenominator(10, 42);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		System.out.println("Testing greatestCommonDenominator(60, 32)");
		result = A1Exercises.greatestCommonDenominator(60, 32);
		expected = 4;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		System.out.println("Testing greatestCommonDenominator(55, 15)");
		result = A1Exercises.greatestCommonDenominator(55, 15);
		expected = 5;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		System.out.println("Testing greatestCommonDenominator(9, 39)");
		result = A1Exercises.greatestCommonDenominator(9, 39);
		expected = 3;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		System.out.println("Testing greatestCommonDenominator(108, 30)");
		result = A1Exercises.greatestCommonDenominator(108, 30);
		expected = 6;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		System.out.println("Testing greatestCommonDenominator(12, 18)");
		result = A1Exercises.greatestCommonDenominator(12, 18);
		expected = 6;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	}
	...
	public static void testCountMatches() {
		...
		int expected = 0;
		int[] arr1 = {2, 3, 2, 0};
		int[] arr2 = {1, 5, 6, 3, 6, 5};
		int[] arr3 = {6, 2, 4, 4, 8, 9, 12};
		int[] arr4 = {1, 2, 2, 2};
		...
		System.out.println("Testing countMatches(arr3, 8)");
		result = A1Exercises.countMatches(arr3, 8);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		System.out.println("Testing countMatches(arr4, 2)");
