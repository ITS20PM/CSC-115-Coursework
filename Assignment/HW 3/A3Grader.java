...
public class A3Grader {
	...
	public static void testRotate() {
		...
		try{
			list1.rotate(1);
			result = list1.frontToBack();
			displayResults(result.equals("{IABCDEFGH}"), "testRotate1");
		}catch(Exception e){
			displayResults(false, "testRotate1");
		}try{
			result = list1.backToFront();
			displayResults(result.equals("{HGFEDCBAI}"), "testRotate2");
		}catch(Exception e){
		...
		try{
			list2.rotate(9);
			result = list2.frontToBack();
			displayResults(result.equals("{ABCDEFGHI}"), "testRotate5");
		}catch(Exception e){
			displayResults(false, "testRotate5");
		}try{
			result = list2.backToFront();
			displayResults(result.equals("{IHGFEDCBA}"), "testRotate6");
		}catch(Exception e){
		...
		try{
			list2.rotate(30);
			result = list2.frontToBack();
			displayResults(result.equals("{GHIABCDEF}"), "testRotate7");
		}catch(Exception e){
			displayResults(false, "testRotate7");
		}try{
			result = list2.backToFront();
			displayResults(result.equals("{FEDCBAIHG}"), "testRotate8");
		}catch(Exception e){
			displayResults(false, "testRotate8");
		}	
	}
	...
	public static void testInterleave() {
		...
		try{
			...
			displayResults(result1.equals("{AX}"), "testInterleave1");
		}catch(Exception e){
			displayResults(false, "testInterleave1");
		}try{
			displayResults(result2.equals("{XA}"), "testInterleave2");
		}catch(Exception e){
		...
		try{
			...
			displayResults(result1.equals("{WB}"), "testInterleave3");
		}catch(Exception e){
			displayResults(false, "testinterleave3");
		}try{
			displayResults(result2.equals("{BW}"), "testInterleave4");
		}catch(Exception e){
		...
		try{
			...
			displayResults(result1.equals("{AWC}"), "testInterleave9");
		}catch(Exception e){
			displayResults(false, "testInterleave9");
		}try{
			displayResults(result2.equals("{CWA}"), "testInterleave10");
		}catch(Exception e){
		...
		try{
			...
			displayResults(result1.equals("{VBX}"), "testInterleave11");
		}catch(Exception e){
			displayResults(false, "testInterleave11");
		}
		try{
			displayResults(result2.equals("{XBV}"), "testInterleave12");
		}catch(Exception e){
