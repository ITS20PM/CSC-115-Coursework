...
public class A3Tester {
	...
	public static void testRemoveBack() {
		...
		list1.addFront("L");
		result = list1.frontToBack();
		displayResults(result.equals("{LINK}"), "testRemoveBack");
		
		list1.removeBack();
		result = list1.frontToBack();
		displayResults(result.equals("{LIN}"), "testRemoveBack");
		
		list1.removeBack();
		result = list1.frontToBack();
		displayResults(result.equals("{LI}"), "testRemoveBack");
		
		list1.removeBack();
		result = list1.frontToBack();
		displayResults(result.equals("{L}"), "testRemoveBack");
