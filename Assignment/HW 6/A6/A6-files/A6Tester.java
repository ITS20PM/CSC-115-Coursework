...
public class A6Tester {
	...
	public static void testPatient() {
		...
		Patient p5 = new Patient(1, "Paul", "A1", new Time(10,14) );
		Patient p6 = new Patient(3, "JK Jee", "B5", new Time(8,17) );
		...
		displayResults(p5.compareTo(p4) < 0, "testing Patient compareTo (priorityLevel)");
		displayResults(p6.compareTo(p1) > 0, "testing Patient compareTo (priorityLevel)");
