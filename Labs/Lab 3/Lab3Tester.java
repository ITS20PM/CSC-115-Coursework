...
public class Lab3Tester {
	...
	public static void testShapeList() {
		...
		displayResults(l.size() == 0, "test contructor with size 0");

		l.add(r00);
		displayResults(l.size() == 1, "test add with size 1");
		...
		l.add(c25);
		displayResults(l.size() == 2, "test add with size 2");
		...
		l.add(r45);
		displayResults(l.size() == 3, "test add with size 3");
		resultString = l.toString();
		expectedString = r00.toString() + "\n" + c25.toString() + "\n"
					 + r45.toString() + "\n";
		//System.out.println("result:" + resultString);
		...
		l.add(r76);
		displayResults(l.size() == 4, "test add with size 4");
		resultString = l.toString();
		expectedString = r00.toString() + "\n" + c25.toString() + "\n"
					 + r45.toString() + "\n" + r76.toString() + "\n";
		//System.out.println("result:" + resultString);
		...
		l.removeFront();
		displayResults(l.size() == 3, "test removeFront with size 3");
		resultString = l.toString();
		...
		l.removeFront();
		displayResults(l.size() == 2, "test removeFront with size 2");
		resultString = l.toString();
		...
		l.removeFront();
		displayResults(l.size() == 1, "test removeFront with size 1");
		resultString = l.toString();
		...
		l.removeFront();
		displayResults(l.size() == 0, "test removeFront with size 0");
		resultString = l.toString();
		expectedString = "";
		//        System.out.println("result:" + resultString);
		//        System.out.println("expected:" + expectedString);
